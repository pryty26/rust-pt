...
```
cd existing_repo
git remote add origin https://gitlab.torproject.org/pryty26/reality-pt.git
git branch -M main
...
* [Set up project integrations](https://gitlab.torproject.org/pryty26/reality-pt/-/settings/integrations)
